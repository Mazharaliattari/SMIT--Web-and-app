...
var brand = document.getElementById("Barand")
var search = document.getElementById("watchesData")
...
function selectedBrand() {
    ...
    for (var key1 in watches[selectBrand]) {
        // console.log(key1)
        brand.innerHTML += `
        <option value='${watches[selectBrand][key1].name}'>${watches[selectBrand][key1].name}</option>
...
function watchsearch() {
    for (var key2 in watches[selectBrand]) {
        if (selectProduct === watches[selectBrand][key2].name) {

            search.innerHTML += `
    <div class="col">
      <div class="card" style="width: 18rem;">
      <img src = "${watches[selectBrand][key2].img}">
        <div class="card-body">
          <h3 class="card-title"></h3>
          <h6 class="card-subtitle mb-2 text-body-secondary">${watches[selectBrand][key2].category}</h6>
          <!-- <p class="card-text">The Oyster Perpetual Explorer in Oystersteel features a distinctive black dial with characteristic 3, 6, and 9 numerals with a Chromalight display. Its highly legible hour markers, extremely resistant Oystersteel and waterproofness have made it a tool watch for exploration.</p> -->
          <h4>${watches[selectBrand][key2].price}</h4>
